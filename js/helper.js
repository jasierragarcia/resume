...
var HTMLnavProjects = '<li class="nav-li"><a href="#" id="#projects" class="nav-link">%data%</a></li>';
var HTMLnavWork = '<li class="nav-li"><a href="#" id="#work" class="nav-link">%data%</a></li>';
var HTMLnavEdu = '<li class="nav-li"><a href="#" id="#education" class="nav-link">%data%</a></li>';
var HTMLnavContact = '<li class="nav-li"><a href="#" id="#contact" class="nav-link">%data%</a></li>';
...
var HTMLworkEmployer = '<div href="#" id="employer">%data%</div>';
var HTMLworkDates = '<div id="work-date">%data%</div>';
var HTMLworkLocation = '<div class="location-text">%data%</div>';
var HTMLworkDescription = '<p id="work-description"><br>%data%</p>';
...
var HTMLonlineHead = '<h2>Online Courses</h2>';
